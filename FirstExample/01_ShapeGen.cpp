...
void display(void)
{
	...
	g_grid.BufferShape(&ibo, &points_vbo, &colors_vbo);
	...
	/*g_plane.ColorShape(1.0f, 0.0f, 1.0f);
	g_plane.BufferShape(&ibo, &points_vbo, &colors_vbo);
	...
	/*g_cube.BufferShape(&ibo, &points_vbo, &colors_vbo);
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(6.0f, 0.0f, -3.0f));
	glDrawElements(GL_TRIANGLES, g_cube.NumIndices(), GL_UNSIGNED_SHORT, 0);*/

	/*g_prism.BufferShape(&ibo, &points_vbo, &colors_vbo);
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(2.0f, 0.0f, -2.0f));
	glDrawElements(GL_LINE_STRIP, g_prism.NumIndices(), GL_UNSIGNED_SHORT, 0);*/

	g_cone.ColorShape(1.0f, 0.5f, 0.0f);
	g_cone.BufferShape(&ibo, &points_vbo, &colors_vbo);
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(2.0f, 0.0f, -2.0f));
